...
const firebaseFallbackConfig = {
  ...
  storageBucket: 'sakura-auth-66415.appspot.com',
  // Correct storage bucket hostname for Firebase Storage is typically appspot.com
  // legacy value above may be malformed; use appspot.com by default.
